...
ALLOWED_HOSTS = ['.elasticbeanstalk.com', 'ptskumba.org', 'www.ptskumba.org', 'api.ptskumba.org']
...
STATICFILES_DIRS = [BASE_DIR / "static", BASE_DIR / "templates"]
