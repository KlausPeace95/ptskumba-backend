...
class UserRegistrationSerializer(serializers.ModelSerializer):
    """
    Serializer for user registration/signup functionality.
    ...
    def create(self, validated_data):
        ...
        Remove password_confirm and set password properly.
        """
...
# NEW: User Registration with Token Serializer  
class UserRegistrationWithTokenSerializer(UserRegistrationSerializer):
    """
    Registration serializer that returns user data with authentication token.
    """
    token = serializers.SerializerMethodField(read_only=True)
    
    class Meta:
        model = CustomUser
        fields = UserRegistrationSerializer.Meta.fields + ['token']
        extra_kwargs = UserRegistrationSerializer.Meta.extra_kwargs
    ...
    def to_representation(self, instance):
        """
        Override to return user-friendly data after registration.
        """
        data = {
            'id': instance.id,
            ...
            'username': f"{instance.first_name} {instance.last_name}" if instance.first_name and instance.last_name else instance.email,
            'isAdmin': instance.is_staff,
            'isAccountant': instance.is_accountant,
            'isTeacher': instance.is_teacher,
            'isParent': instance.is_parent,
